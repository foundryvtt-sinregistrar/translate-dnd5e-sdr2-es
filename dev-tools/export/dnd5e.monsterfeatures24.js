(async () => {
    const PACK_ID = "dnd5e.monsterfeatures24";
    ...
    const getDescriptionHTML = (doc) => {
        // Items suelen ser system.description.value
    ...
    const extractEffects = (doc) => {
        ...
        for (const e of arr) {
            ...
            // Igual que tus otros scripts: name (y description si existe)
    ...
    for (const id of ids) {
        ...
        // Clave por ID del documento (como en tus otros exports “phb.../mm...”)
